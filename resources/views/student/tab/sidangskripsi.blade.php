        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('student/simpanjadwalsidangskripsi') }}" class="invoices-links active">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8 col-md-8">
                                <div class="invoices-tabs">
                                    <ul>
                                        <li><a href="{{ route('student/jadwalsidangproposal') }}">Proposal</a></li>
                                        <li><a href="{{ route('student/jadwalsidanghasil') }}">Hasil</a></li>
                                        <li><a class="active" href="{{ route('student/jadwalsidangskripsi') }}">Skripsi</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="invoices-settings-btn">
                                    <a href="{{ route('student/jadwalsidangskripsi') }}" class="btn">
            ...
            @if ($jadwalSidangSkripsi->isEmpty())
                <div class="error-box">
                    <h1>466</h1>
                    ...
                    <a href="{{route('student/addJadwalSidang')}}" class="btn btn-primary">Add Sidang Skripsi</a>
                </div>
            @else
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-12 d-flex">
                            <div class="card invoices-grid-card w-100">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <a href="view-invoice.html" class="invoice-grid-link">Sidang Skripsi</a>
                                ...
                                <div class="card-middle">
                                    <h2 class="card-middle-avatar">
                                        <a href="profile.html">
                                            <img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ URL::to('/svg/skripsi_icon.svg') }}" alt="User Image"> {{ $jadwal->judul_skripsi }} 
                                        </a>
                                    </h2>
                                </div>
                                <div class="card-body">
