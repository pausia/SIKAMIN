                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('student/update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Mahasiswa Information
                                            <span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('name_full') is-invalid @enderror" name="name_full" value="{{ $studentEdit->name_full }}">
                                            @error('name_full')
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Nim/Stanbuk <span class="login-danger">*</span></label>
                                            <input type="text" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ $studentEdit->nim }}">
                                            @error('nim')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms calendar-icon">
                                            <label>Dosen Pembimbing I <span class="login-danger">*</span></label>
